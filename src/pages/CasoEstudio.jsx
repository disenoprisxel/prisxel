...
const cases = {
  ...
  arkeim: {
    ...
    before: 'Arkeím Studio no contaba con un sitio web propio. A pesar de más de 8 años de trayectoria y 120+ proyectos entregados, no tenían una plataforma digital que respaldara ese nivel de experiencia: no existía un espacio donde mostrar la calidad de sus diseños arquitectónicos ni el detalle de sus acabados a clientes potenciales. Una firma de ese calibre necesitaba una presencia digital que transmitiera la misma solidez y profesionalismo que sus proyectos construidos.',
    challenge: 'El reto era ir más allá de una galería de fotos estática. Arkeím necesitaba un sitio visualmente atractivo y con interacción real, donde el usuario pudiera explorar cada proyecto desde todos sus ángulos, percibir el profesionalismo del diseño arquitectónico y apreciar la elegancia de los acabados con el mismo nivel de detalle que se vive en persona.',
    objectives: [
      'Permitir explorar cada proyecto arquitectónico desde todos sus ángulos',
      'Transmitir el profesionalismo y rigor del diseño de la firma',
      'Resaltar la elegancia y calidad de los acabados de cada obra',
      'Posicionar a Arkeím como una firma de arquitectura de alto nivel',
    ],
    solution: 'Desarrollamos un visor 3D interactivo que permite explorar los modelos arquitectónicos desde cualquier ángulo directamente en el navegador, sin instalar nada. Lo complementamos con una galería de proyectos con lightbox para una visualización detallada de cada obra, junto con fichas de especificaciones técnicas y artísticas que documentan el proceso, los materiales y los acabados de cada proyecto.',
    features: [
